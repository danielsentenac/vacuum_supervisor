...
#define MyAppExeName "vacuum-supervisor.cmd"
...
SetupIconFile={#StageDir}\vacuum-supervisor.ico
UninstallDisplayIcon={app}\vacuum-supervisor.ico
...
Source: "{#StageDir}\vacuum-supervisor.ico"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{userprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\vacuum-supervisor.ico"
Name: "{userdesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\vacuum-supervisor.ico"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\Classes\{#MyAppProtocol}\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\vacuum-supervisor.ico,0"; Flags: uninsdeletekey
