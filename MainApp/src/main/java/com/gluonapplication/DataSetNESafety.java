...
public class DataSetNESafety extends DataSet {
   ...
   public DataSetNESafety(String name) {
      ...
      list.addElement(new DataElement("NESourcePCAL", Type.CIRCLE_PCAL_STATUS_COLOR, "PCAL_NE_laser_enbl_20kHz_MAX"));
      list.addElement(new DataElement("NEPCAL",       Type.CIRCLE_PCAL_STATUS_COLOR, "PCAL_NE_laser_on_20kHz_50Hz_MAX"));
      list.addElement(new DataElement("NEPCAL",       Type.CIRCLE_PCAL_STATUS_COLOR, "PCAL_NE_laser_enbl_20kHz_MAX"));
